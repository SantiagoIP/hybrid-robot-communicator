      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h3 className="text-lg font-semibold text-gray-800 mb-2">Robot Integration in Human-Machine Teams</h3>
            <p className="text-sm text-gray-600">
              Exploring the evolution of human-robot collaboration from isolation to full integration.
            </p>
          </div>
          <div className="flex flex-col items-end">
            <p className="text-sm text-gray-600 mb-2">© 2023 Robot Integration Project</p>
